...
VLLM_MAX_MODEL_LEN_A="${VLLM_MAX_MODEL_LEN_A:-4096}"
VLLM_MAX_MODEL_LEN_B="${VLLM_MAX_MODEL_LEN_B:-4096}"
RUNTIME_MAX_MODEL_LEN_A="${RUNTIME_MAX_MODEL_LEN_A:-${VLLM_MAX_MODEL_LEN_A}}"
RUNTIME_MAX_MODEL_LEN_B="${RUNTIME_MAX_MODEL_LEN_B:-${VLLM_MAX_MODEL_LEN_B}}"
...
echo "Process A: batch=${BATCH_SIZE_A}, gpu_memory_utilization=${VLLM_GPU_MEMORY_UTILIZATION_A}, max_model_len=${VLLM_MAX_MODEL_LEN_A}"
echo "Process B: batch=${BATCH_SIZE_B}, gpu_memory_utilization=${VLLM_GPU_MEMORY_UTILIZATION_B}, max_model_len=${VLLM_MAX_MODEL_LEN_B}"
...
(
  ...
  VLLM_MAX_MODEL_LEN="${VLLM_MAX_MODEL_LEN_A}" \
...
(
  ...
  VLLM_MAX_MODEL_LEN="${VLLM_MAX_MODEL_LEN_B}" \
